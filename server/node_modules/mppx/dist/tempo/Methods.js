...
export const session = Method.from({
    ...
    schema: {
        ...
        request: z.pipe(z
            ...
            .check(z.refine(({ amount, decimals }) => parseUnits(amount, decimals) > 0n, 'Session amount must be greater than 0')), z.transform(({ amount, chainId, channelId, decimals, escrowContract, feePayer, minVoucherDelta, suggestedDeposit, ...rest }) => ({
            ...rest,
            amount: parseUnits(amount, decimals).toString(),
            ...(suggestedDeposit
                ? {
